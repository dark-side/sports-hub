...
![Admin user sees the Make as Admin button within actions dropdown against active user](/desktop_application_features/user_management/images/user_management_page_with_action_dropdown_for_active_user.png)
