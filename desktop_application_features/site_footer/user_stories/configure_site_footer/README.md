...
Then I see the configuration table with the following rows:
  ...
  <i>The <b>Newsletter</b> is described [in separate feature](/desktop_application_features/newsletter_email)</i>
...
![Admin user clicks + New footer page and sees a pop-up window](/desktop_application_features/site_footer/images/new_footer_item_popup.png)

**2. Admin user sees an edit form for the menu item:**

![Admin user sees an edit form for the menu item](/desktop_application_features/site_footer/images/new_footer_item_form.png)

**3. Admin user sees an edit form for Contact us:**

![Admin user sees an edit form for Contact us](/desktop_application_features/site_footer/images/footer_contact_us_form.png)

**4. Admin user sees Contributors tab:**

![Admin user sees Contributors tab](/desktop_application_features/site_footer/images/footer_contributors_tab.png)
