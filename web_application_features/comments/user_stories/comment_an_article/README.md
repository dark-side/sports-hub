...
![Not logged-in users see comments on the article page](/web_application_features/comments/images/comments_for_no_logged_in_user.png)
...
![Users see comments block with sub-comments](/web_application_features/comments/images/sub_comments.png)

**4. Users enter a comment text to the input field:**

![Users enter a comment text to the input field](/web_application_features/comments/images/posting_comments_in_progress.png)

**5. Users see "Log in to leave comments" pop-up window:**

![Users see "Log in to leave comments" pop-up window](/web_application_features/comments/images/log_in_to_leave_comments_popup.png)
