...
![Admin user sees a list of articles](/desktop_application_features/manage_articles/images/articles_list.png)

**2. Admin user clicks subcategory filter and sees the options:**

![Admin user clicks subcategory filter and sees the options](/desktop_application_features/manage_articles/images/conferences_filter.png)

**3. Admin user clicks status filter and sees the options:**

![Admin user clicks status filter and sees the options](/desktop_application_features/manage_articles/images/status_filter.png)

**4. Admin user clicks the search icon and sees an input field:**

![Admin user clicks the search icon and sees an input field](/desktop_application_features/manage_articles/images/search_field.png)
...
![Admin user sees a category preview page](/desktop_application_features/manage_articles/images/category_preview_page.png)
