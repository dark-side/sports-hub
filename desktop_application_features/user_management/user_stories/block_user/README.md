...
![Admin user sees actions dropdown against active user](/desktop_application_features/user_management/images/user_management_page_with_action_dropdown_for_active_user.png)

**2. Admin user sees warning pop-up window on the user block:**

![Admin user sees warning pop-up window on the user block](/desktop_application_features/user_management/images/before_user_block_warning_popup.png)
