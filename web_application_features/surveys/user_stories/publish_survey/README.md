...
![Admin user sees actions for unpublished and published surveys in the Reader Poll](/web_application_features/surveys/images/admin_non_published_actions.png)
