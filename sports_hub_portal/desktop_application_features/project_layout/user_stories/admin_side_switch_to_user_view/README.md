...
![Admin user hovers over the Switch to user view](/sports_hub_portal/desktop_application_features/project_layout/images/admin_side_switch_to_user.png)

**3. Admin user hovers over the Switch to admin view:**

![Admin user hovers over the Switch to admin view](/sports_hub_portal/desktop_application_features/project_layout/images/user_side_switch_to_admin.png)
