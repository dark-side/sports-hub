...
![AAdmin user sees filter on the Teams page and the Apply and Cancel buttons being disabled](/desktop_application_features/maintain_navigation/images/manage_teams_page.png)

**2. Admin user sees filter on the Teams page and the Apply and Cancel buttons being enabled:**

![Admin user sees filter on the Teams page and the Apply and Cancel buttons being enabled](/desktop_application_features/maintain_navigation/images/teams_page_active_filter_buttons.png)
