...
![Admin user sees the user management page with filter dropdown](/desktop_application_features/user_management/images/user_management_page_with_filter_dropdown.png)
