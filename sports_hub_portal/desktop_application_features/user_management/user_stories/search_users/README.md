...
![Admin user sees search users input field when clicking the magnifier icon](/sports_hub_portal/desktop_application_features/user_management/images/user_management_page_with_search_input_field.png)
