...
![Admin user sees actions for the subcategory](/desktop_application_features/maintain_navigation/images/ia_subcategory_actions.png)
...
![Admin user drag and drops the menu item to reorder](/desktop_application_features/maintain_navigation/images/ia_drag_and_drop_1.png)

**4. Admin user drag and drops the menu item to move:**

![Admin user drag and drops the menu item to move](/desktop_application_features/maintain_navigation/images/ia_drag_and_drop_2.png)
