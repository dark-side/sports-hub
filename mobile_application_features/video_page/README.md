...
No           |      Name     |   Details
------------ | ------------- | -------------
1 |[**Allow users to view videos in the application**](/mobile_application_features/video_page/user_stories/user_video_list/README.md)|<pre>As a user</br>I want to able to view sports news videos</pre>
