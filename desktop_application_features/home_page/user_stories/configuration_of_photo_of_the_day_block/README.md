...
![Admin user hovers over the uploaded photo and sees an icon to upload another photo](/desktop_application_features/home_page/images/photo_of_day_hover.png)
