...
![Admin user sees a new team form](/web_application_features/maintain_navigation/images/new_team_form.png)

**2. Admin user selects a logo in the form:**

![Admin user selects a logo in the form](/web_application_features/maintain_navigation/images/new_team_form_with_logo.png)

**3. Admin user sees a success message:**

![Admin user sees a success message](/web_application_features/maintain_navigation/images/success_message.png)
