...
![Admin user hovers over uploaded article image and sees a resize icon](/web_application_features/manage_articles/images/article_image_hover_editor.png)

**2. Admin user clicks resize icon and sees a size editor:**

![Admin user clicks resize icon and sees a size editor](/web_application_features/manage_articles/images/article_image_size_editor.png)
