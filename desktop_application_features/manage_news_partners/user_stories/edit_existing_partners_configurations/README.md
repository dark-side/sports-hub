...
![Admin user sees confirmation pop-up window on the cancelation form](/desktop_application_features/manage_news_partners/images/cancel_confirmation_popup.png)
