...
![Admin user sees default Information architecture configuration page](/web_application_features/maintain_navigation/images/ia_category_only.png)

**2. Admin user selects the category and sees subcategories:**

![Admin user selects the category and sees subcategories](/web_application_features/maintain_navigation/images/ia_subcategory_only.png)

**3. Admin user selects the subcategory and sees teams:**

![Admin user selects the subcategory and sees teams](/web_application_features/maintain_navigation/images/ia_with_team.png)

**4. Admin user sees actions for the subcategory and hidden NFL category:**

![Admin user sees actions for the subcategory and hidden NFL category](/web_application_features/maintain_navigation/images/ia_subcategory_actions.png)
...
![Admin user clicks to add the category and sees a pop-up window](/web_application_features/maintain_navigation/images/ia_new_category_popup.png)
...
![Admin user clicks Delete the subcategory and sees a pop-up window](/web_application_features/maintain_navigation/images/ia_delete_popup.png)
