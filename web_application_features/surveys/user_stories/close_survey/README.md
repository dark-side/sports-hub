...
![Admin user sees actions for the published survey](/web_application_features/surveys/images/admin_published_actions.png)

**2. Admin user sees the Closed tab:**

![Admin user sees the Closed tab](/web_application_features/surveys/images/admin_surveys_closed_tab.png)
