...
No           |      Name     |   Details
------------ | ------------- | -------------
1 |[**Allow users to view the application in supported languages**](/mobile_application_features/application_languages/user_stories/users_change_application_language/README.md)|<pre>As an application user<br>I want to be able to view the application in supported languages</pre>
