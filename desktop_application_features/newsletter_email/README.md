...
No           |      Name     |   Details
------------ | ------------- | -------------
1 |[**Allow admin user to configure Newsletter footer section**](/desktop_application_features/newsletter_email/user_stories/configure_newsletter/README.md)|<pre>As an admin user<br>I want to be able to configure Newsletter footer section</pre>
