...
No           |      Name     |   Details
------------ | ------------- | -------------
1 |[**Allow users to view news from configured partners**](/mobile_application_features/news_partners/user_stories/viewing_news_from_partners/README.md)|<pre>As a user<br>I want to be able to see news from the configured partners in the appropriate categories</pre>
