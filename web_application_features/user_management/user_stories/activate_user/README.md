...
![Admin user sees actions dropdown against blocked users](/web_application_features/user_management/images/user_management_page_with_action_dropdown_for_blocked_user.png)
