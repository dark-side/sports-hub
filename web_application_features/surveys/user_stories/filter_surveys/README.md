...
![Admin user sees Status filter options](/web_application_features/surveys/images/admin_status_filter.png)

**2. Admin user sees a search input field after clicking the search icon:**

![Admin user sees a search input field after clicking the search icon](/web_application_features/surveys/images/admin_search.png)
